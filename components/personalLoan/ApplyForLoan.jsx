          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="section-header text-center">
                <h5 className="sub-title">Quick & easy Personal loan</h5>
                <h2 className="title">Take One Step Closer to Your Dream.</h2>
                <p>
                  Get personal loans approved within days with transparent
                  lending criteria, less paperwork and transparent processes.
                </p>
              </div>
            </div>
          </div>
